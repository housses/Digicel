trigger triggerSummarizeOpportunitiesInsert on Opportunity (after insert) {
    Id[] recordTypeIds = new Id[]{ // set of id types and adds it into the recordTypeIds
    ...
    System.debug('Trigger is running: triggerSummarizeOpportunitiesInsert'); 
